...
* **Identifying the most frequent category**, enabling to prioritize interventions.
...
* **Requirements Analysis**
  * Enables the identification, analysis, and formalization of user needs (e.g., demand for nighttime traffic classification) into computational requirements that guide system design.
...
* **Written Communication**
  * Needed to produce a well-structured and technically sound report that documents the design rationale, implementation decisions, and validation strategies. This ensures that results are effectively communicated to technical and non-technical audiences, such as Transit Departament.
...
1. **Identify** system requirements and constraints based on stakeholder input, particularly the needs expressed by Transit Department for traffic data analysis and classification.
...
- **Requirements Analysis:**
    - Necessary to accurately identify and formalize the needs of Transit Department technicians, ensuring that system requirements are well understood and properly implemented.
...
**Responsible**
- Demonstrate commitment to the quality of the solution, meeting deadlines, and ensuring that Transit Department technical requirements are fully addressed.
...
- **Apply** *Requirements Analysis* to correctly identify and specify the essential requirements of the system. Students must elicit  needs, interpret sensor data, and define criteria for traffic analysis, ensuring that user requirements are translated into practical functionalities in the developed solution.
