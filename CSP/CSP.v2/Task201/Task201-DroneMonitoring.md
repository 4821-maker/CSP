...
A technician from SOS Florestal, who is also a computing student at university, brought this problem to be tackled collaboratively by their classmates, aiming to develop a functional prototype of the drone's surveillance module.
...
One team member must upload to the university Virtual Learning Environment (AVA), by **11:59 PM on 04/03/2022**, a **JFLAP file** containing the **drone surveillance module**, along with a **technical report in SBC (Brazilian Computer Society) article format** that details the design and operation of the module.
