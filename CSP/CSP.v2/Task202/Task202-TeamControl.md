...
The student team from university, responsible for developing the prototype, analyzed the new requirement and concluded that **a simple finite state machine is not sufficient to solve the problem**. This raises an important question: what factors led them to this conclusion?
...
One team member must submit, through the university Virtual Learning Environment (AVA), by **6:00 PM on 05/02/2022**, the following deliverables:
